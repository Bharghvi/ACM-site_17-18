...
<body>
  ...
  <button onclick="topFunction()" id="myBtn" title="Go to top"><i class="fa fa-chevron-up" style="color: white; font-size: 1.5em"></i></button>
    ...
    <div id="headerblock" class="middle">
      <ul id="navigationpanel">
        <li id="0" class="ac"><a href="./index.html">Home</a></li>
      ...
      <?php
            ...
            $result=mysqli_query($conn, $sql);
              while($row=mysqli_fetch_array($result))
              {
                ...
                $photourl = $isphotoavailable ? "/acm/img/committee/" . $id . ".jpg" : "//nitsurat.acm.org/committee/unknown.jpg";
                ?>
  ...
  <div class="footer-content">
    ...
    <h4>Get Social</h4>
      <a class="social" href=#>  <i style="color : #3B5998; font-size: 1.5em;margin-top: 20px" class="fa fa-facebook-square"></i></a>

       <a class="social" href=#><i style="color: #d34836; font-size: 1.5em;margin-top: 20px" class="fa fa-google"></i></a>

      <a class="social" href=#><i style="color: #4099ff; font-size: 1.5em;margin-top: 20px" class="fa fa-twitter"></i></a>
      </div>
    <div class="f2">
